      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8 grid grid-cols-12 gap-5">
        ...
        >
          <div className="rounded-3xl overflow-hidden col-span-2 aspect-[16/9]">
            <img src={fachada} alt="Fachada de la farmacia" loading="lazy" className="w-full h-full object-cover" />
          </div>
          ...
          <div className="rounded-3xl bg-primary text-primary-foreground p-6 flex flex-col justify-between aspect-square">
            ...
            <div className="text-sm opacity-90">años cuidando la salud de nuestra comunidad</div>
          </div>
        </motion.div>
        ...
        >
          ...
          <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-5xl mt-2 leading-tight">
            La farmacia del barrio, con alma de calidad.
          </h2>
          <p className="mt-5 text-muted-foreground">
            Acompañamos a familias con medicamentos originales, atención farmacéutica responsable y delivery puntual. Detrás del mostrador hay un equipo de profesionales que te asesora con la misma confianza con la que atendemos en persona.
          </p>
          ...
          <div className="mt-6 text-sm text-muted-foreground">
            Q.F. Responsable colegiado · Autorización sanitaria vigente.
          </div>
        </motion.div>
      </div>
    </section>
